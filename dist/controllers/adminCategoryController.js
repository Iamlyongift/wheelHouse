...
const createCategory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const newCategory = yield CategoryModel_1.default.create({ name, description });
        res
            .status(201)
...
const updateCategory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const updatedCategory = yield CategoryModel_1.default.findByIdAndUpdate(categoryId, req.body, {
            new: true,
        });
        if (!updatedCategory) {
